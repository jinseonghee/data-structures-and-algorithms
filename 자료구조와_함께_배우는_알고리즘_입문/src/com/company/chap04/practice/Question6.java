package com.company.chap04.practice;

public class Question6<E> { //컬랙션의 자료형은 element의 <E>
	...
	// 생성자
	public Question6(int capacity) {
		num = front = rear = 0;
		max = capacity;
		try {
			que = (E[])new Object[max]; // 자료형을 Obect로 받고 <E>타입으로 형변환
